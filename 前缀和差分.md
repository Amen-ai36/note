...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        int X1 = lower_bound(x.begin(), x.end(), x1) - x.begin();
        int X2 = lower_bound(x.begin(), x.end(), x2) - x.begin();

        int Y1 = lower_bound(y.begin(), y.end(), y1) - y.begin();
        int Y2 = lower_bound(y.begin(), y.end(), y2) - y.begin();
    ...
    for (int i = 0; i < x.size(); i++)
    {
        ...
        {
            a[i][j] =
                d[i][j] + (i ? a[i - 1][j] : 0) + (j ? a[i][j - 1] : 0) - (i && j ? a[i - 1][j - 1] : 0);
        }
    }
